...

{
	...
	'summary': "App Print Dynamic check print dynamic cheque print dynamic bank check bank check print print bank check bank cheque print bank cheque account cheque generate Dynamic cheque  Check writing print check dynamically Cheque format Bank Check Print bank check",
	'description': """
